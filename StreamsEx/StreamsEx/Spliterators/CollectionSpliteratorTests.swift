//
//  CollectionSpliteratorTests.swift
//  Streams
//
...
class CollectionSpliteratorTests: XCTestCase {
...
//        
//        // when
//        var spliterator = RandomAccessCollectionSpliterator(collection: array)
//        
...
//    }
    ...
    func testThatItDoesntSplitsIfThereIsNothingToSplit() {
        ...
        // when
        var spliterator = ArraySpliterator(array: array)
